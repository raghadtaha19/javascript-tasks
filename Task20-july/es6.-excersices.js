...
function compareObjects(obj1, obj2) {
    // قم بالتحقق من أن عدد المفاتيح في الكائن الأول يطابق عدد المفاتيح في الكائن الثاني
    if (Object.keys(obj1).length !== Object.keys(obj2).length) {
      return false;
    }
  
    // قم بالتحقق من أن قيم كل مفتاح في الكائن الأول تطابق قيم المفاتيح المماثلة في الكائن الثاني
