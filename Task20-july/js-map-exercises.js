...
function stringItUp(arr){
  ...
  let stringItUp1 =arr.map(function(el){
    return el.toString();
  });
  console.log(stringItUp1);
...
function capitalizeNames(arr){
  ...
  let capitalizeNames1 =arr.map(function(el){
    return el.toUpperCase();
  });
  console.log(capitalizeNames1);
...
function namesOnly(arr){
  // your code here
  let namesOnly1=arr.map(function(el){
    return el.name;
  });
 return namesOnly1;
}
